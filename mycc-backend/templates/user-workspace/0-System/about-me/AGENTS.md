...
3. 阅读 `0-System/memory/YYYY-MM-DD.md`（今天 + 昨天）获取近期上下文
...
- **每日笔记：** `0-System/memory/YYYY-MM-DD.md`（如需要请创建 `0-System/memory/` 目录）— 发生事件的原始记录
- **长期记忆：** `0-System/about-me/MEMORY.md` — 你精心整理的记忆，就像人类的长期记忆
- **中期上下文：** `0-System/context.md` — 每周收敛与阶段目标
...
- 你可以在主会话中**自由读取、编辑和更新** `0-System/about-me/MEMORY.md`
- 记录重要事件、想法、决策、观点、经验教训
- 这是你精心整理的记忆 — 提炼的精华，而非原始日志
- 随着时间推移，回顾你的每日文件并将值得保留的内容更新到 `0-System/about-me/MEMORY.md`

### 📝 写下来 - 不要"心理笔记"！

- **记忆是有限的** — 如果你想记住什么，就写到文件里
- "心理笔记"无法在会话重启后保留。文件可以。
- 当有人说"记住这个" → 更新 `0-System/memory/YYYY-MM-DD.md` 或相关文件
...
- 更新文档
- 提交和推送你自己的更改
- **回顾和更新 `0-System/about-me/MEMORY.md`**（见下文）
...
3. 用提炼的内容更新 `0-System/about-me/MEMORY.md` 与 `0-System/context.md`
