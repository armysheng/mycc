...
export const SKILL_REGISTRY: SkillDefinition[] = [
  ...
  },
  {
    ...
    source_url: 'https://github.com/openai/codex/tree/main/codex-cli/skills/skill-installer',
    origin_type: 'community',
  ...
  },
  {
    ...
    source_url: 'https://github.com/openai/codex/tree/main/codex-cli/skills/spreadsheet',
    origin_type: 'community',
