---
name: scheduler
description: 道友 AI 自动化与定时任务服务，按计划执行助理任务。触发词："/scheduler"、"定时任务"、"启动定时"、"查看定时"
---

# 道友 AI 自动化

定时任务功能内置在道友 AI 自动化服务中，服务可用后会按计划自动执行助理任务。
