...
const checks: Check[] = [
  ...
  {
    label: 'operator docs expose rollback preflight gate',
    file: 'README.md',
    snippets: [
      'docs/e2b-release-readiness.md',
      'npm run harness:verify -- --target=landing --no-write',
  ...
  },
  {
    ...
    snippets: [
      ...
      'do-not-stage',
      'unclassified',
      'mycc-backend/scripts/verify-rollback-preflight.ts',
      'mycc-backend/src/scripts/rollback-preflight-readiness.ts',
  ...
  {
    label: 'landing PR checklist exposes rollback preflight gate',
    file: 'docs/landing-pr-submit-checklist.md',
    snippets: [
      'npm run landing:classify -- --fail-on-unclassified',
      'npm run verify:rollback-preflight',
      'npm run verify:e2b-release',
