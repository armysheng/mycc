...
`codex/p1-auth-readiness-hotfix-v2`. It is written for staging verification,
...
`codex/p1-auth-readiness-hotfix-v2`. Do not deploy the full dirty working tree.

Placeholder sequence:

```bash
# Build or fetch the backend-only hotfix artifact from codex/p1-auth-readiness-hotfix-v2.
